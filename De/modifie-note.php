  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <form method="post">
			<center>					
                <div class="form-inline" >
                            <div class="input-group">
                                <input class="form-control" name ="ok" type="search" placeholder="Search" aria-label="Search">
        ...
        {
            $id = $_POST['ok'];
            $cherche= $info2->recherche_note($id);
            // $ok = ucwords($ok);
        ...
        <div class="graph">
                ...
                <?php 
                    ...
                    <tr>
                        ...
                        <td><?php echo $etud_info['CodeSMSTRE']; ?></td>
                        <td><?php echo $etud_info['LibelleCLS']; ?></td>
                       <td>
                        <a class="tooltips" href="note-modif.php?Id=<?php echo $etud_info['CodeNTE']; ?>"><i class="btn btn-danger"><input type="submit" value="modifier" style="background-color:orangered;color:white;border:none"></i></a></td>
                    </tr>
                <?php $s_sn++; }}}
                 ?>
                </tbody> 

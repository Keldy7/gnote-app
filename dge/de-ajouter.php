 ...
 if(isset($_POST['submit']))
 {
	...
	$password = $_POST['password'];
	 ...
	 else
	 {
		 ...
		 $ajout_de = $info2->ajouter_de($nom,$prenoms,$tel,$email,$login,$password);
		 if($ajout_de==true){
			 echo "<script>window.location = 'de-information.php';</script>";
		 }
		 else
		 {
			 echo "<script>alert('Remplissez correctement les champs');</script>";
		 }
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            <div class="card-header"  style="background-color:orangered">
                <h3 class="card-title">Formulaire d'enregistrement du directeur des etudes</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->

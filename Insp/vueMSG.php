...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" href="vueMSGDE.php">
                <i class="far fa-bell"></i>
    ...
    <div class="content-wrapper">
        ...
        <div class="graph">
                ...
                <?php 
                    ...
                    <tr>
                        <td><?php echo $s_sn; ?></td>																
                        <td><?php echo $message_info['MatriculeET']; ?></td>
                        <td><?php echo $message_info['EmailET']; ?></td>
                        <td><?php echo $message_info["CONCAT(E.NomET,' ',E.PrenomET)"]; ?></td>
                        <td><?php echo $message_info['DescMsg']; ?></td>
                        
                        <td><a class="tooltips" href="de-suprimer.php?Id=<?php echo $message_info['CodeET']; ?>"><i class="fa fa-trash" style="color:orangered"></i></a>
                        <a class="tooltips" href="repondre.php?Id=<?php echo $message_info['CodeET']; ?>"><i class="fa fa-edit" style="color:rgb(18, 219, 18);"></i></a></td>
                    </tr>
                <?php $s_sn++; }} ?>
                </tbody> 

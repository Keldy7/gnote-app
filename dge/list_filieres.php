...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
		...
		<?php
            $info_filiere_ecole=	$info2->filiere_ecole();
            $s_sn = 1;
        ?>
        ...
        <div class="graph">
                ...
                <?php 
                    if($info_filiere_ecole->num_rows>0){


                    while($dge_info =$info_filiere_ecole->fetch_assoc()){ ?>						

                    <tr>
                        <td><?php echo $s_sn; ?></td>																
                        <td><a href="list_classes.php?codeFil=<?php echo $dge_info['CodeFIL'];?>"><?php echo $dge_info['LibelleFIL']; ?></a></td>

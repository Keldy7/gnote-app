...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
		...
		<?php
            $info_matieres_smtre = $info2->matieres_smtre($_GET['codeSmstre']);
            $s_sn = 1;
        ?>
        ...
        <div class="graph">
                ...
                <?php 
                    if($info_matieres_smtre->num_rows>0){


                    while($dge_matieres_smtre =$info_matieres_smtre->fetch_assoc()){ ?>						

                    <tr>
                        <td><?php echo $s_sn; ?></td>																
                        <td><a href="list_etud.php?codeMat=<?php echo $dge_matieres_smtre['CodeMAT'];?>&codeCLS=<?= $_GET['codeCLS'] ?>"><?php echo $dge_matieres_smtre['LibelleMAT']; ?></a></td>

...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <?php
            $iaffiche_prof_class_mat=	$info2->afficher_prof_classe_matiere($_GET['CodeCLS'], $_GET['CodeProf']);
            $s_sn = 1;
        ?>
        ...
        <div class="graph">
                <div class="tables">
                    ...
                    <table class="table table-bordered "> 
                        ...
                        <tr>
                            <td><?php echo $s_sn; ?></td>																
                            <td><a href="etudiantsClasse.php?codeCLS=<?php echo $_GET['CodeCLS']; ?>&codeMAT=<?php echo $mat_info['CodeMAT']; ?>&libmat=<?php echo $mat_info['LibelleMAT']; ?>"><?php echo $mat_info['LibelleMAT']; ?></a></td>
                        </tr>
                            <?php $s_sn++; }} ?>
                        </tbody> 

    ...
    <div class="content-wrapper">
        ...
        if (isset($_GET['id'])) {
            if (isset($_GET['id'])!="") {
               ...
               try {
                    $info_classe= $info2->afficher_prof_classe($_GET['id']);
                    $s_sn = 1;             
                } catch (Exception $e) {
        ...
        ?>
            <div class="ibox-content">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                    <?php 
                        if($info_classe->num_rows>0){


                        while($classe_info = $info_classe->fetch_assoc()){ ?>    
                            <tr>
                                <td><?php echo $s_sn; ?></td>
                                <td><?php echo $classe_info['LibelleCLS']; ?></td>
                                <td><?php echo $classe_info['LibelleFIL']; ?></td>
                                <td><?php echo $classe_info['LibelleEcole']; ?></td>
                                <td>
                                    <a href="prof-infoClassMat.php?idCls=<?= $classe_info['CodeCLS'] ?>&amp;idProf=<?= $_GET['id'] ?>"><button class="btn btn-info btn-sm">Ouvrir</button></a>
                                </td>

...
if (isset($_POST['submit'])) {
    ...
    if ($libelle == "") {
        ...
        $ajout_fil = $info2->ajouter_fil($libelle, $ecole, $insp);
        if ($ajout_fil == true) {
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header" style="background-color:orangered">
                            <h3 class="card-title">CREATION DE FILIERE</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="CodeEcole" id="">
                                        <?php
                                            $ecoles=$info2->ecole();
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="CodeINSP" id="">
                                        <?php

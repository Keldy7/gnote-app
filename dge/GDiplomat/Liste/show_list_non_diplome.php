                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Liste Des Non Diplômés</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="invoice p-3 mb-3 planche">
                                ...
                                <div class="row no-print">
                                    <div class="col-12">
                                        <a href="print_list_non_diplome.php" rel="noopener" target="_blank" class="btn btn-default""><i class=" fas fa-print"></i> Print
                                        </a>

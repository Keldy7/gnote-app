...
<head>
    ...
    <title>GDiplomat | Diplômes</title>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="../planches/index.php" class="nav-link" style="margin-left:20px;color:rgb(18, 219, 18);font-weight:bold">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Diplômes</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <a href="edit_diplome.php" rel="noopener" target="_blank">
                                                            <button type="button" class="btn btn-default btn-sm">
                                                                <i class="far fa-edit"></i>
                                                            </button>
                                                        </a>

    ...
    echo "<script>alert('veillez remplir tous les champs');</script>";
	 ...
	 {            
         ...
         if ($infoLoginProf->num_rows>0) {
             ...
             $ajout_de = $info2->ajouter_profAMatiere($codeProf,$matiere);
             ...
             {
                 echo "<script>alert('Une erreur s\'est produite lors de l\'attribution');</script>";
             }         
         }
         else
         {
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            <div class="card-header"  style="background-color:orangered">
                <h3 class="card-title">Attribution d'un professeur à une matière</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <select class="form-control" name="matiere" id="matiere">
                                <?php
                                    $listeMatiere=$info2->remplirListeMatiere();
                                    if($listeMatiere->num_rows>0){
                                        while($matiere_info = $listeMatiere->fetch_assoc()){ ?>
                                        <option value="<?php echo $matiere_info['CodeMAT'] ?>"><?php echo $matiere_info['LibelleMAT'] ?></option>
                                    <?php }
                                    }
                                ?>
                            </select>

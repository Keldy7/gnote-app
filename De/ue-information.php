                    ...
                    <?php 
                        ...
                        while($emement_info = $info_liste->fetch_assoc()){ ?>    
                            <tr>
                                ...
                                <td><?php echo $emement_info['CoefficientUE']; ?></td>
                                <td><a href="ue-infoMatiere.php?voir=<?= $emement_info['CodeUE'] ?>"><button class="btn btn-info btn-sm">Ouvrir</button></a></td>
                            </tr>
                    <?php $s_sn++; }} ?>
                    </tbody>
                </table>

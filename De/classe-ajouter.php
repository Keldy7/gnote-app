<?php 
 ...
 if(isset($_POST['submit']))
 {
    ...
    echo "<script>alert('veillez remplir tous les champs');</script>";
	 ...
	 {
        try {
            $ajout_de = $info2->ajouter_classe($libelle,$codeFiliere);
             if($ajout_de==true){
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            <div class="card-header"  style="background-color:orangered">
                <h3 class="card-title">Création de classe</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <select class="form-control" name="filiere" id="filiere" >
                               <option value="1">STIC</option>
                               <option value="2">STGP</option>
                               <option value="3">STGI</option>
                            </select>
                        </div>
                    </div>
                </div>

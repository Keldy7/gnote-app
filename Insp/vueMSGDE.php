  ...
  <div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" href="vueMSG.php" title="Message des etudiants">
                <i class="far fa-bell"></i>
                <span class="badge badge-warning navbar-badge"><?php echo $not ?></span>
            </a>
        </li>
        <li class="nav-item dropdown">
            <a class="nav-link" href="vueMSGDE.php" title="Message du directeur">
                <i class="far fa-bell"></i>
    ...
    <div class="content-wrapper">
		...
		<?php
            $info_message=	$info2->LeMessagerDE();
            $s_sn = 1;
        ?>
        ...
        <div class="graph">
                ...
                <?php 
                    ...
                    <tr>
                        <td><?php echo $s_sn; ?></td>																
                        <
                        <td><?php echo $message_info['EmailDE']; ?></td>
                        <td><?php echo $message_info["CONCAT(D.NomDE,' ',D.PrenomDE)"]; ?></td>
                        <td><?php echo $message_info['DescMsg']; ?></td>
                        
                        <td><a class="tooltips" href="de-suprimer.php?Id=<?php echo $message_info['CodeDE']; ?>"><i class="fa fa-trash" style="color:orangered"></i></a>
                        <a class="tooltips" href="repondre.php?Id=<?php echo $message_info['CodeDE']; ?>"><i class="fa fa-edit" style="color:rgb(18, 219, 18);"></i></a></td>
                    </tr>
                <?php $s_sn++; }} ?>
                </tbody> 

...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <p><strong>Sélectionner l'étudiant</strong></p>
		<?php
        ...
        <div class="graph">
                ...
                <?php 
                    ...
                    <tr>
                        ...
                        <td><a class="tooltips" href="Modifier.php?Id=<?php echo $etud_info['CodeET']; ?>"><i class="fa fa-edit" style="color:rgb(18, 219, 18);"></i></a></td>
                    </tr>
                <?php $s_sn++; }} ?>
                </tbody> 

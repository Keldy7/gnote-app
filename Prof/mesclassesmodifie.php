...
<p><strong>Sélectionner la classe</strong></p> 
<?php
        ...
        <div class="graph">
                ...
                <?php 
                    ...
                    <tr>
                        <td><?php echo $s_sn; ?></td>																
                        <td><?php echo $class_info['LibelleCLS']; ?></td>
                        <td><a href="mesmatieresmodifie.php?idCls=<?= $class_info['CodeCLS'] ?>">Modifier les notes</a></td>
                    </tr>
                <?php $s_sn++; }} ?>
                </tbody> 

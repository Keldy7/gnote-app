...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
		...
		<?php
            $info_classe_filiere=	$info2->classe_filiere($_GET['codeFil']);
            $s_sn = 1;
        ?>
        ...
        <div class="graph">
                ...
                <?php 
                    if($info_classe_filiere->num_rows>0){


                    while($dge_info_classe =$info_classe_filiere->fetch_assoc()){ ?>						

                    <tr>
                        <td><?php echo $s_sn; ?></td>																
                        <td><a href="list_smtres.php?codeCls=<?php echo $dge_info_classe['CodeCLS'];?>"><?php echo $dge_info_classe['LibelleCLS']; ?></a></td>

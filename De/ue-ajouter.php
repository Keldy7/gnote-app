 ...
 if(isset($_POST['submit']))
 {
    ...
    echo "<script>alert('veillez remplir tous les champs');</script>";
	 ...
	 else
	 {
		 ...
		 /*$ajout_de = $info2->ajouter_UE($libelle, $coefficient);
		 if($ajout_de==true){
         ...
         try {
            $ajout_de = $info2->ajouter_UE($libelle, $coefficient);
             if($ajout_de==true){
                 echo "<script>window.location = 'ue-information.php';</script>";
             }                
            } catch (Exception $e) {
                echo "<script>alert('Erreur, La cet UE exist déjà !');</script>";
            }
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            <div class="card-header"  style="background-color:orangered">
                <h3 class="card-title">Création d'unité d'enseignement</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->

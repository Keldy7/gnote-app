...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
		...
		<?php
            $info_semestre_classe =	$info2->semestre_classe($_GET['codeCls']);
            $s_sn = 1;
        ?>
        ...
        <div class="graph">
                ...
                <?php 
                    if($info_semestre_classe->num_rows>0){


                    while($dge_semtre_classe =$info_semestre_classe->fetch_assoc()){ ?>						

                    <tr>
                        <td><?php echo $s_sn; ?></td>																
                        <td><a href="list_matieres.php?codeSmstre=<?php echo $dge_semtre_classe['CodeSMTRE'];?>&codeCLS=<?= $_GET['codeCls'] ?>"><?php echo $dge_semtre_classe['LibelleSMTRE']; ?></a></td>
